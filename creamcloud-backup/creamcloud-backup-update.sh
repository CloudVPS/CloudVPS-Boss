...
echo "To avoid any issues, we have disabled the update process."
echo "The upgrade process is not included in this version of the script. Upgrading can be done manually."
