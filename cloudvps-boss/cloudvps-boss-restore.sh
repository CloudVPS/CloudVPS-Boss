...
DIALOG_7_MESSAGE="Please enter the snapshot ID. This can be found with the command cloudvps-boss-list it is a string with random characters which looks like: 69af8005 although the characters may be different."
