...
lecho "restic unlock --remove-all --repo ${BACKUP_BACKEND} --password-file=/etc/cloudvps-boss-v3/restic-password.conf --cleanup-cache --verbose=1"
...
lecho "restic prune --repo ${BACKUP_BACKEND} --password-file=/etc/cloudvps-boss-v3/restic-password.conf --cleanup-cache --verbose=1"
